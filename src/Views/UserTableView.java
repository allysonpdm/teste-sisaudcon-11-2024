 ...
 * @author phoen
 */
public class UserTableView extends javax.swing.JFrame {

    private UserController controller;
    private String[] columnNames = {"ID", "Nome", "Email", "Criado em", "Atualizado em", "", ""};
    ...
    private PaginateResponse performSearch(String search, Integer currentPage, Integer perPage) {
        return controller.listPaginate(search, currentPage, perPage);
    }

    private void extractUserData(PaginateResponse response) {
        String errorMessage = response.getErrorMessage();
        if (errorMessage != null) {
            JOptionPane.showMessageDialog(null, errorMessage, "Erro", JOptionPane.ERROR_MESSAGE);
        }
        users = (List<UserDto>) response.getList();
    ...
    private void editUser(UserDto user) {
        UserFormView userFormView = new UserFormView(user, () -> {
            response = performSearch(fieldSearch.getText(), currentPage, perPage);
            fillTable(response);
        });
        userFormView.setTitle("Editar usuário - ID: " + user.getId());
    ...
    private void deleteUser(UserDto user) {
        ...
        int confirm = JOptionPane.showOptionDialog(
                null,
                "Você tem certeza que deseja excluir o usuário '" + user.getName() + "'?\r\nEssa ação não podera ser desfeita.",
                "Confirme a sua ação",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserTableView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserTableView().setVisible(true);
            }
        });
    }
